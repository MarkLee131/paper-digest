...
Thirteen papers through screening, and the argument they make together is about **validation** — specifically, about what happens when the thing being validated is generated by a language model and the oracle was designed for code written by a human.
</div>
